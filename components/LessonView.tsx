      ...
      if (isHtml) {
          ...
          return (
              <div className="fixed inset-0 z-50 bg-white flex flex-col animate-in fade-in">
                  ...
                  <div className="flex-1 overflow-y-auto w-full pt-16 pb-6 px-0 md:px-8 bg-slate-50">
                      <div 
                          ref={contentRef}
                      ...
                      />
                      {isStreaming && (
                        <div className="flex items-center gap-2 text-slate-600 mt-4 px-4 md:px-8 animate-pulse pb-4">
